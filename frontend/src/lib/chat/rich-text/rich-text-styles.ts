export const RICH_TEXT_CONTENT_CLASS =
  ...
  "[&_a]:text-primary [&_a]:underline [&_a]:[overflow-wrap:anywhere] " +
  ...
  "[&_pre]:my-1 [&_pre]:max-w-full [&_pre]:overflow-x-auto [&_pre]:rounded-md [&_pre]:bg-muted [&_pre]:px-3 [&_pre]:py-2 [&_pre]:font-mono [&_pre]:text-[13px] " +
